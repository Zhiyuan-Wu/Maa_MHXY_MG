...
| yunbiao_renwu2 | 90–360s | >1000s / 贴 2400 | 07.24 渣中 2352、晚风 2222 异常 |
...
| huoli | 45–55s | >120s | |
| kejuxiangshi | 90–100s | >300s | 答题任务；07.24 缤纷 620 = 题库 / AI 卡题 |
...
| # | 症状 / 日志特征 | 判定 | 处置 / 说明 |
|---|---|---|---|
| ① | `活动-运镖-开始-点击参加` on_error ×5（每号一张），yunbiao 仍"完成" | **设计内** | `yunbiao_renwu2.json` 里该节点 `on_error:[运镖完成onerror]` 就是正常完成出口；非 bug |
